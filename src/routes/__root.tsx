...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "MarFrios Distribuidora — Atacadista de Laticínios" },
      { name: "twitter:description", content: "Laticínios de qualidade para o seu negócio. Atacado e varejo em São José do Rio Preto - SP." },
